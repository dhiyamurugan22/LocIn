...
import StudentAnalysisModule from '../../StudentAnalysisModule';
import { AreaChart, Area, XAxis, YAxis, CartesianGrid, Tooltip, ResponsiveContainer, BarChart, Bar } from 'recharts';
import { TrendingUp, Award, BookOpen, Target, CheckCircle2, Clock } from 'lucide-react';
...
export default function DashboardPage() {
  ...
  const [activeTab, setActiveTab] = useState('analytics'); // 'analytics' | 'profile-setup'
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
      ...
      >
        <div>
          <h1 style={{ fontSize: '1.75rem', fontWeight: '800', marginBottom: '0.25rem' }}>
            Welcome back, <span className="gradient-text">Student Learner</span> 👋
          </h1>
        ...
        <div style={{ display: 'flex', gap: '0.75rem' }}>
          <button
            ...
            style={{
              ...
              fontWeight: '600',
              cursor: 'pointer',
              backgroundColor: activeTab === 'analytics' ? 'var(--accent-primary)' : 'var(--bg-tertiary)',
              color: '#fff',
              transition: 'all 0.2s',
            }}
          >
          ...
          <button
            ...
            style={{
              ...
              fontWeight: '600',
              cursor: 'pointer',
              backgroundColor: activeTab === 'profile-setup' ? 'var(--accent-primary)' : 'var(--bg-tertiary)',
              color: '#fff',
              transition: 'all 0.2s',
            }}
          >
            Student Profiler Form
          </button>
        </div>
      </div>
      ...
      {activeTab === 'analytics' ? (
        ...
        <div className="glass-panel" style={{ padding: '1.5rem', borderRadius: 'var(--radius-lg)' }}>
          <StudentAnalysisModule onChange={(data) => setProfileData(data)} />
        </div>
      )}
    </div>
  );
